...
\begin{definition}
  ...
  \lean{Mbar}
  \leanok
  Let $r \ge 0$ be a real number, and let $S$ be a finite set.
...
\begin{definition}
  ...
  \lean{Mbar_le}
  \leanok
  Let $r \ge 0$ and $c \ge 0$ be real numbers, and let $S$ be a finite set.
...
\begin{definition}
  ...
  \leanok
  \uses{BD_data, sigma_add, sigma_proj, BD_double}
...
\begin{definition}
  ...
  with these definition $(n, f, h)$ forms a Breen--Deligne package.
\end{definition}
