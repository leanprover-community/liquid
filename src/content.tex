...
\begin{lemma}
  ...
  \lean{system_of_complexes.is_weak_bdd_exact_for_bdd_degree_above_idx.to_exact}
  \uses{is_bdd_exact_for_bdd_degree_above_idx, is_weak_bdd_exact_for_bdd_degree_above_idx}
...
\begin{lemma}
  ...
  \uses{ is_weak_bdd_exact_for_bdd_degree_above_idx}
  \lean{system_of_complexes.is_weak_bdd_exact_for_bdd_degree_above_idx.controlled_y}
...
\begin{lemma}
  ...
  \lean{system_of_complexes.is_weak_bdd_exact_for_bdd_degree_above_idx.completion}
...
\begin{lemma}
  ...
  \lean{system_of_complexes.is_weak_bdd_exact_for_bdd_degree_above_idx.strong_of_complete}
...
\end{lemma}
\begin{proof}
  \uses{is_bdd_exact_for_bdd_degree_above_idx_of_weakly}
