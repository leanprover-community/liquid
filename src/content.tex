...
\begin{definition}
  ...
  \[
    \left\{ \left( \sum_{n \ge 1} a_{n,s} T^n \right)_{s \in S} \middle\vert \sum_{n \ge 1, s \in S} |a_{n,s}| r^n \le \infty \right\}
  \]
\end{definition}
...
\begin{definition}
  ...
  \]
  and we define
  $\hat V(\overline{\mathcal M}_{r'}(S)_{\le c})^{T^{\pm 1}}$
  to be the equalizer of $(T^{\pm 1})^*$, and $[T^{\pm 1}]$.
  In other words, the kernel of $(T^{\pm 1})^* - [T^{\pm 1}]$.
\end{definition}
...
\begin{definition}
  ...
  restricts to a map
  \[
    \hat V(\overline{\mathcal M}_{r'}(S)_{\le c_2}^n)^{T^{\pm 1}} \to
    \hat V(\overline{\mathcal M}_{r'}(S)_{\le c_1}^m)^{T^{\pm 1}}
  \]
\end{definition}
...
\begin{definition}
  ...
  \[
    \dots \to
    \hat V(\overline{\mathcal M}_{r'}(S)_{\le c_{i+1}}^{n_{i+1}})^{T^{\pm 1}} \to
    \hat V(\overline{\mathcal M}_{r'}(S)_{\le c_i}^{n_i})^{T^{\pm 1}}
    \to \dots \to 0.
  \]
