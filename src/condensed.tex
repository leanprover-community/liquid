...
\begin{lemma}
  ...
  Then $\Ext_{\CondMod_{\mathbb Z[T^{-1}]}}^i(\Lbar{r'}}(S), V) = 0$ for all $i \ge 0$.
\end{lemma}
...
\begin{lemma}
  ...
  \[ 0 \to \mathbb Z[T^{-1}][S] \to \mathcal L_{r'}(S) \to \Lbar_{r'}(S) \to 0.  \]
\end{lemma}
...
\begin{lemma}
  ...
  \[
    0 \to \mathcal L_{r'}(S) \to \mathcal L_{r'}(S) \to \Mm_{p'}(S) \to 0
  \]
...
\begin{proof}
  ...
  \[ \Ext^i_{\Cond(\Ab)}(\Mm_{p'}(S),V) \cong \Ext_{\CondMod_{\mathbb Z[T^{-1}]}}^i(\mathcal L_{r'}(S), V). \]
  TODO
\end{proof}
