...
\begin{definition}
  \label{png-cats}
  \uses{chpng-Tinv}
  \lean{CompHausFiltPseuNormGrp.large_category, CompHausFiltPseuNormGrp₁.large_category, ProFiltPseuNormGrp.large_category, ProFiltPseuNormGrp₁.large_category, ProFiltPseuNormGrpWithTinv₁.large_category}
  \leanok
