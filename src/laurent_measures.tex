...
\end{proof}
% \begin{corollary}\label{corollary:lim_an} We have
% \[
% \lim_{n\to+\infty}\left\lfloor\frac{y_n}{\xi^n}\right\rfloor\xi^n =0.
% \]
% \end{corollary}
% \begin{proof} Immediate from Lemma~\ref{lemma:bounded}, since $\lim_{n}\xi^n=0$ because $0<\xi<1$.
% \end{proof}
